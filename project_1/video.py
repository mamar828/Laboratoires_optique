...
class Video:
    ...
    def crop(self, x_slice, y_slice):
        ...
        with open(f"/Users/felixdesroches/Desktop/ULaval_labs/PHY_2006_optique/Laboratoires_optique/project_1/crop_slices/{self.filename.split('/')[-1].split('.')[0]}.txt", "w") as f:
